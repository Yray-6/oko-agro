...
const CreatePasswordForm: React.FC = () => {
  ...
  const handleInputChange = (field: keyof CreatePasswordFormValues, value: string) => {
    setFormData(prev => ({
      ...prev,
      [field]: value,
    }));
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 bg-white/80 rounded-lg shadow-lg max-w-md mx-auto lg:mx-0">
      ...
      <div className="mb-6 sm:mb-8">
        <h1 className="text-2xl sm:text-3xl font-semibold text-mainGreen mb-2">Create New Password</h1>
        <p className="text-gray-600 text-xs sm:text-sm">Enter your new preferred password</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
        ...
        <div>
          ...
          {errors.newPassword && (
            <div className="text-red-500 text-xs mt-1 bg-red-50 p-2 rounded-md">{errors.newPassword}</div>
          )}
        </div>
        ...
        <div>
          ...
          {errors.confirmPassword && (
            <div className="text-red-500 text-xs mt-1 bg-red-50 p-2 rounded-md">{errors.confirmPassword}</div>
          )}
        </div>
