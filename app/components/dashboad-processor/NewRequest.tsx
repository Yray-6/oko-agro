...
const ListNewRequestModal: React.FC<ListNewProductModalProps> = ({
  isOpen,
  onClose,
  onSuccess,
}) => {
        ...
        {hasFiles && (
          <div className="mt-2">
            {isMultiple ? (
              ...
              <p className="text-xs text-green-600">{(files as File).name}</p>
            )}
          </div>
        )}
      </div>
                  ...
                  <Form className="space-y-8">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600 mb-6">
                        Add clear photos of your product. Good photos get more
                        views!
                      </p>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                          <input
                            ...
                            className="hidden"
                            onChange={(e) =>
                              handleFileUpload(e, setFieldValue, "mainPicture")
                            }
                          />
                          <PictureUploadBox
                        ...
                        <div>
                          ...
                          <PictureUploadBox
                            ...
                            onClick={() =>
                              document
                                .getElementById("additionalPictures")
                                ?.click()
                            }
                          ...
                          <div>
                            ...
                            <div className="relative">
                              <input
                                ...
                                onChange={(e) =>
                                  setFieldValue("harvestDate", e.target.value)
                                }
        ...
        >
          ...
          <div className="space-y-4 mb-10">
            <p className="text-black leading-relaxed">
              Thank you for adding your product. Our inspection team will review
              it shortly to ensure it meets quality standards.
            </p>
            <p className="text-black leading-relaxed">
              Our inspection team will review it shortly to ensure it meets
              quality standards.
            </p>
          </div>
...
export { ListNewRequestModal, SuccessModal };
