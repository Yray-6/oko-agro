...
const EditProfileProcessor: React.FC = () => {
  ...
  return (
    <div className="bg-white rounded-lg border border-gray-200 p-6">
      ...
      >
       ...
       Your profile update has been submitted successfully. Our team will review the changes and your details will be updated accordingly. 
          </p>
        </div>
...
export default EditProfileProcessor;
